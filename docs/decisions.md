...
- Les 20 paires main du jalon 1 sont écrites d'emblée dans ce schéma.
...
- Fabrication : Neo4j Community en Docker local, driver Python officiel, seeds YAML versionnés, export validé. Passe LLM hors v1, toujours validée contre le graphe.
