...
- **Fabrication → Jeu** : la fabrication produit le fichier de paires figé (JSON), seul artefact partagé, validé par un schéma commun. Le jeu n'a aucune dépendance au graphe (voir [ADR-0001](./docs/adr/0001-fichier-de-paires-fige.md)).
