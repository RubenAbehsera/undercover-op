...
Un jeu de soirée façon « Undercover », joué sur l'univers *One Piece*. À chaque
manche, la table reçoit un personnage — sauf l'imposteur, qui en reçoit un autre,
lié au premier, sans savoir qu'il est l'imposteur. Indices à tour de rôle, vote,
révélation. L'hôte fixe à la création de la room un **calibrage** : l'arc le plus
avancé que la table accepte de voir, et rien au-delà ne sortira.

Cartographie des contextes : [CONTEXT-MAP.md](./CONTEXT-MAP.md). Décisions de
fond : [docs/decisions.md](./docs/decisions.md) et [docs/adr/](./docs/adr/).
